...
export default function FichaFinanceiraModal({ tenant, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4" role="dialog" aria-modal="true">
      ...
      <div className="relative w-full sm:max-w-2xl bg-white border border-paper-400 rounded-t-[10px] sm:rounded-[10px] shadow-2xl overflow-hidden max-h-[100dvh] sm:max-h-[calc(100dvh-2rem)] flex flex-col">
