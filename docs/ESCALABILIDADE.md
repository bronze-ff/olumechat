...
```text
olume:tenant:42:config:v3
olume:tenant:42:user:817:rbac
olume:tenant:42:agent:19:presence
olume:tenant:42:rate:user:817:send
```
...
| `REDIS_PREFIX` | prefixo do ambiente, por exemplo `olume:prod` |
