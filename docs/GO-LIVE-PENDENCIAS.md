...
| **FIL-100** | Staging sobe sozinho após CI verde | Infra pronta e verificada; falta o workflow |
| **FIL-101** | Promoção para produção sob aprovação + rollback | Depende de FIL-100 e FIL-105 |
