...
|---|---|---|
| frontend | `https://falatta.vercel.app` | `https://seu-dominio.com.br` |
| backend | `https://falatta.onrender.com` | `https://api.seu-dominio.com.br` |
...
2. crie um bucket privado, por exemplo `falatta-media-prod`;
