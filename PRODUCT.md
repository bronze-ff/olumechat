...
- Do not preserve the visual identity or vocabulary of Multicanal Atacado.
- Do not look like a generic white-label admin template or a marketing landing page placed around product controls.
- Do not use oversized decorative metrics, excessive pills, nested cards, warm beige canvases, glass effects, or ornamental gradients.
- Do not imitate Zenvia or EZSoft branding. Use their clear journey language and category expectations only as competitive context.
- Do not expose implementation vocabulary when a task-focused explanation is possible.
...
Meet WCAG 2.2 AA for color contrast, focus visibility, keyboard operation, semantics, and target sizing. Never rely on color alone for status. Respect reduced-motion preferences, keep essential text at readable sizes, and preserve complete workflows on small screens.
